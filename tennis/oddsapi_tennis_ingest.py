"""
oddsapi_tennis_ingest.py
========================
Fetches and displays best moneyline odds for tennis matches using Odds API.
"""
import os
import requests
from typing import List, Dict

def fetch_tennis_moneylines(api_key: str, regions: str = "us", markets: str = "h2h") -> List[Dict]:
...
if __name__ == "__main__":
    ...
    if not api_key:
        ...
        exit(1)
    odds_data = fetch_tennis_moneylines(api_key)
